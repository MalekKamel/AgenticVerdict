 ...
 *
 * This script:
 * 1. Generates an admin JWT token using crypto
...
const JWT_SECRET = process.env.JWT_SECRET || "zkSDFkSuvcdwgqHyid0qhUn7a8gMfd2YZ+zqsnXNLM4=";
...
/**
 * Generate an admin JWT token using crypto (HS256)
 */
