...
Create the following documentation files under `/specs/00-core/{sub-phase-slug}/` (for example `00-foundation`, `01-connectors`, `02-intelligence`, `03-insights`, `04-production-hardening`):
