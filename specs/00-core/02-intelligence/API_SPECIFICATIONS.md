...
**Implements:** [Remediation Plan — Part 2](/specs/00-core/REMEDIATION_PLAN.md) tasks **R-1–R-4** (routes), **R-5** (auth), **R-6** (rate limit)
...
Full field list and Zod constraints are defined in [Remediation Plan — R-7](/specs/00-core/REMEDIATION_PLAN.md#task-r-7-standardize-verdict-schema-for-all-phases). API consumers MUST treat this as the **canonical** verdict JSON shape.
...
- [Remediation Plan](/specs/00-core/REMEDIATION_PLAN.md)
