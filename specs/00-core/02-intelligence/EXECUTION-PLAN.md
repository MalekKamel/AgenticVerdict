...
**Path note:** This folder is canonical: `specs/00-core/02-intelligence/`. Phase duration in `overview.md` is described as **Weeks 5–6**; if the master roadmap uses different week indices, treat the **task order and exit criteria** here as authoritative for sequencing, not the calendar label.
...
- [Phase 1 README](../01-connectors/README.md) (prerequisite)
- [Phase 3 README](../03-insights/README.md) (next phase; confirm path if renamed)
