...
2. **Terminology:** Product and marketing terms match the glossary — see [`docs/06-reference/localization/arabic-glossary.md`](../../../docs/06-reference/localization/arabic-glossary.md) (draft terms + reviewer deliverables).
