/**
 * RegisterForm — `@agenticverdict/ui` + `design/system/atoms.lib.pen` / `design/system/molecules.lib.pen`.
 */
...
import { AUTH_PEN, AuthPenAlert, AuthPenButton, AuthPenCheckbox } from "@/components/auth/pen";
import { FormField, Input, Typography } from "@agenticverdict/ui";
    ...
    <div className={className}>
      ...
      {register.isError ? (
        <div className="mb-4" data-testid="form-error">
          <AuthPenAlert variant="error" title={t("errors.apiError")} className="max-w-none">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Typography variant="body-sm" color="secondary" as="div">
              ...
              <a
                ...
                className="font-normal underline decoration-from-font hover:underline"
