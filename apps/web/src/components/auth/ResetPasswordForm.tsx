    ...
    <div className={className}>
      <form onSubmit={form.onSubmit(handleSubmit)} onKeyDown={handleKeyDown}>
        <div className="flex flex-col gap-6">
          {apiError ? (
            <AuthPenAlert variant="error" title={t("common.error")} className="max-w-none">
              <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            <PasswordInput
              ...
              aria-describedby="reset-password-hint password-requirement-minlength password-requirement-uppercase password-requirement-lowercase password-requirement-number password-requirement-special"
            ...
            >
              {tPassword("requirements.minLength")}
            </p>
          </div>
