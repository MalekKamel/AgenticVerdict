...
// Note: Replace AnyRouter with the concrete AppRouter from @agenticverdict/api when the backend is wired.
...
export const authApi = {
  ...
  > => {
    // This will be implemented once tRPC router is available
    ...
    // Real implementation (uncomment when tRPC router is ready):
    // return wrapMutation(
  ...
  > => {
    ...
    // Real implementation (uncomment when tRPC router is ready):
    // return wrapMutation(
    //   trpc.auth.confirmPasswordReset.mutate(input)
    // )
  },
};
