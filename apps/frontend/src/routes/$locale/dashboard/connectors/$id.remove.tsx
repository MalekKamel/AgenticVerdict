...
export const Route = createFileRoute("/$locale/dashboard/connectors/$id/remove")({
  beforeLoad: createDashboardParentBeforeLoad(),
  component: lazyRouteComponent(() => import("@/features/connectors/pages/ConnectorRemovePage")),
});
