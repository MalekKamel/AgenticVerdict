...
│
├── 01-design/                   # Design tokens, theming, foundations
│   ├── README.md
│   ├── overview.md
│   ├── tasks.md
│   └── acceptance-criteria.md
...
**Relationships:** Builds on `01-design/`; consumed by `03-organisms/` and `04-pages/`
...
**Relationships:** Documents components from `02-components/` and `03-organisms/`; references `01-design/` tokens
...
- `01-design/` sub-phase defines token system and theming
