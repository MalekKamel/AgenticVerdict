...
2. **UI Generation Reference**
   - Path: `/docs/architecture/business/design-system/generation/ui-generation-quick-reference.md`
   - Contains: Pencil.dev workflows and generation protocols

3. **Design System Documentation**
   - Path: `/docs/architecture/business/design-system/`
...
- **Follow** component patterns defined in `/design-system/README.md`
...
/docs/architecture/business/design-system/
...
- [ ] Consult `/design-system/README.md` for existing patterns
- [ ] Reference `ui-generation-quick-reference.md` for Pencil.dev usage
- [ ] Verify no duplicate component implementations exist
- [ ] Ensure Pencil MCP server tools are used for generation
...
- **UI Generation**: `/docs/architecture/business/design-system/generation/ui-generation-quick-reference.md`
- **Design Documentation**: `/docs/architecture/business/design-system/`
