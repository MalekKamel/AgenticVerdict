...
- `specs/00-core/02-intelligence/README.md` and related `specs/00-core/02-intelligence/*.md`
- `specs/00-core/03-insights/README.md` and related `specs/00-core/03-insights/*.md`
- `changelog/2026-04-08-phase-02-03-systematic-implementation-consolidation.md` (consolidated narrative; standalone execution-plan markdown was never checked in)
