...
Much of **Phase 2 below (Platform Integration)** is implemented in the repository as **Core platform: Connectors** under [`specs/00-core/01-connectors/`](../../specs/00-core/01-connectors/README.md) (`@agenticverdict/data-connectors`, health routes, operations docs). The checklist items in this file are **historical planning**; use `specs/00-core/*/acceptance-criteria.md` and [`requirements.md`](./requirements.md) (v1.1+) for current mandatory behavior (e.g. **required `tenantId`** on adapters). Dated implementation notes: [`changelog/`](../../changelog/) files prefixed `2026-04-04-phase-01-`.
