...
| `apps/web`                                       | Older docs may say `apps/web`; the **current** app path is **`apps/frontend`**.                                                                                                                                                                                                                                            |
...
| **Dev auth mock**          | `VITE_PUBLIC_AUTH_API_MOCK` — SSR guard skipped in dev when mock enabled                                                                                                                  | Desktop dev must align env so **session semantics** match web (see §8.2).                                                                                             |
