...
await mcp__pencil__open_document({
  filePathOrTemplate:
    "/Users/apple/Desktop/dev/ai/tasks/AgenticVerdict/design-system/atoms/button.pen",
});
```
...
const components = await mcp__pencil__batch_get({
  filePath: "/path/to/design-system/atoms/button.pen",
...
const tokens = await mcp__pencil__get_variables({
  filePath: "/Users/apple/Desktop/dev/ai/tasks/AgenticVerdict/design-system/design-tokens.pen",
});
...
await mcp__pencil__get_screenshot({
  filePath: "/Users/apple/Desktop/dev/ai/tasks/AgenticVerdict/design-system/atoms/badge.pen",
...
await mcp__pencil__open_document({
  filePathOrTemplate: "/path/to/design-system/design-tokens.pen",
});

// 2. Extract design tokens
const tokens = await mcp__pencil__get_variables({
  filePath: "/path/to/design-system/design-tokens.pen",
});
...
await mcp__pencil__open_document({
  filePathOrTemplate: "/path/to/design-system/atoms/new-component.pen",
});

// 2. Find empty space for new component
const space = await mcp__pencil__find_empty_space_on_canvas({
  filePath: "/path/to/design-system/atoms/new-component.pen",
  width: 200,
  height: 100,
  padding: 20,
  direction: "bottom",
...
- Design tokens: `/design-system/design-tokens.pen`
- Component library: `/design-system/atoms/*.pen`, `/design-system/molecules/*.pen`
...
```typescript
// From design-system/atoms/badge.pen

// 1. Get all badge variants
const badges = await mcp__pencil__batch_get({
  filePath: "/design-system/atoms/badge.pen",
  patterns: [{ name: /^badge-/ }],
  readDepth: 1,
});
...
// 4. Get design tokens
const tokens = await mcp__pencil__get_variables({
  filePath: "/design-system/design-tokens.pen",
});
