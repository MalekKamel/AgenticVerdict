...
This directory contains project oversight documentation for project managers, technical leadership, and stakeholders.
...
- Report on project health and risks
...
**Project Charter**: The single source of truth for project objectives, scope, and success criteria.
