...
This section holds **meta** documentation: how the `docs/` tree is organized, migration history, and repository-wide status snapshots.

## Contents

| Document                                                         | Purpose                                                                            |
| ---------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [documentation-structure.md](./documentation-structure.md)       | Original consolidation plan, taxonomy, and migration matrix                        |
| [development-status-summary.md](./development-status-summary.md) | Point-in-time inventory of implemented vs planned work (update after major merges) |
| [reviews/](./reviews/)                                           | Post-implementation reviews (e.g. Phase 01) and remediation tracking               |
