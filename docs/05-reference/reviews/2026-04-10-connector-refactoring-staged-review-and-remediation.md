...
| -------------------------------------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Core schema: agency partners, tenants FK, insights, insight_connectors, usage, connector registry + tags | **Met**         | `packages/database/src/schema/core/{tenants,connectors,insights,usage}.ts`, `seed-connectors.ts`, `tenants` enhancements.                                                                                                                                                      |
