...
**Issue:** All files in `specs/00-core/01-connectors/operations/` reference old package names
...
**File:** `docs/05-reference/migration-guide-compiler-driven-config.md`
...
5. `docs/03-technology-research/compiler-driven-adapter-config-examples.md`
6. `docs/03-technology-research/compiler-driven-adapter-config-implementation-plan.md`
7. `docs/04-project-management/requirements.md`
8. `docs/04-project-management/roadmap-development.md`
...
1. `docs/05-reference/mock-adapter-pipeline-remediation-plan.md` (Lines 571-572)
...
2. `docs/05-reference/agent-architecture-consolidation-analysis.md` (Line 489)
...
1. **Fully Updated** (8 files)
   ...
   - `docs/05-reference/runbooks/connector-*.md`
   - `docs/05-reference/reviews/2026-04-10-*.md`
...
1. `specs/00-core/01-connectors/operations/API-REFERENCE.md`
   - Lines 3, 5, 11, 25, 79-84
   - Impact: Core API reference will mislead developers

2. `specs/00-core/01-connectors/operations/USAGE-EXAMPLES.md`
   - Lines 9, 13, 48-49, 67
   - Impact: Code examples will not compile

3. `docs/05-reference/migration-guide-compiler-driven-config.md`
   - Lines 36, 56
...
1. `docs/05-reference/mock-adapter-pipeline-remediation-plan.md` (Lines 571-572)
2. `docs/05-reference/agent-architecture-consolidation-analysis.md` (Line 489)
3. `docs/03-technology-research/compiler-driven-adapter-config-examples.md` (Lines 509, 689)
4. `docs/03-technology-research/compiler-driven-adapter-config-implementation-plan.md` (Lines 1016, 1022)
...
1. `docs/04-project-management/*.md` (3 files)
