...
This runbook aligns with execution plan **Part 9** (Weeks 35–38) in [`specs/00-core/03-insights/execution-plan.md`](../../../specs/00-core/03-insights/execution-plan.md): automated verification before and after deploy, monitoring hooks, and smoke checks. Paths below are relative to the repository root.
...
- [`specs/00-core/03-insights/execution-plan.md`](../../../specs/00-core/03-insights/execution-plan.md) — Part 9
