...
| ---- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ----------------------------- | --------------- | ---------------------------------------------- |
| P1-1 | **Stack verification** | Confirm `@tanstack/react-start`, `@tanstack/react-router`, `@tanstack/react-query` versions per memo compatibility; document in `apps/frontend` package README or tech note | None         | Version drift                 | 1               | `pnpm --filter @agenticverdict/frontend build` |
