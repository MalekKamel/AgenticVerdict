...
| --------------------------------------------------------------------------------------------------- | ------------------ | ------- | ------------- |
| `docs/06-reference/runbooks/remediation-known-issues.md`                                            | Line 18            | **LOW** | Runbook       |
| `docs/03-development-phases/phase-03-report-generation/prerequisites/schema-transformation-spec.md` | Lines 9-17         | **LOW** | Specification |
| `docs/03-development-phases/phase-03-report-generation/tasks.md`                                    | Lines 60-96        | **LOW** | Task Docs     |
| `docs/03-development-phases/phase-03-report-generation/gap-analysis.md`                             | Lines 225-264      | **LOW** | Gap Analysis  |
...
- Phase 03 Documentation: `/docs/03-development-phases/phase-03-report-generation/`
- Schema Specification: `/docs/03-development-phases/phase-03-report-generation/prerequisites/schema-transformation-spec.md`
