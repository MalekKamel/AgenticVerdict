...
This directory contains reference materials, lookup documents, and auxiliary resources for all team members.
...
- Auxiliary materials that don't fit in other sections
...
The `ignored/` directory at the project root contains auxiliary and experimental materials that are not part of the core documentation structure.
