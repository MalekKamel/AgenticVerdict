...
| `docs/05-project-management/*.md`                                          | 15+            | Requirements, roadmap, project charter                       |
| `docs/03-development-phases/**/*.md`                                       | 20+            | Phase documentation, acceptance criteria                     |
| `docs/06-reference/*.md`                                                   | 10+            | Architecture analysis, migration guides                      |
| `docs/04-technology-research/*.md`                                         | 8+             | Implementation plans, examples                               |
| `docs/03-development-phases/phase-01-platform-integration/operations/*.md` | 12+            | API reference, runbooks, usage examples                      |
...
# From docs/05-project-management/requirements.md

│ ├── platform-adapters/ # Platform API adapters (@agenticverdict/platform-adapters)
│ │ ├── adapter.ts # PlatformAdapter + BasePlatformAdapter

# From docs/03-development-phases/phase-01-platform-integration/operations/API-REFERENCE.md
...
- `docs/05-project-management/project-charter.md` (lines 196-197): Interface definitions with `PlatformAdapter`, `PlatformType`
- `docs/03-development-phases/phase-00-foundation/tasks.md` (lines 245-246, 252): Task definitions referencing `PlatformAdapter`, `BasePlatformAdapter`, `MockPlatformAdapter`
- `docs/03-development-phases/phase-04-production-hardening/overview.md` (line 111): `NormalizedPlatformSnapshot`
...
# From docs/05-project-management/project-charter.md
...
- `docs/06-reference/mock-adapter-integration.md` (entire file)
...
```markdown
# From docs/03-development-phases/phase-00-foundation/POST-IMPLEMENTATION-GAP-ANALYSIS.md

- `MockPlatformAdapter`, `createSyntheticAdapter`, `useMockAdapter`

# From docs/03-development-phases/phase-00-foundation/tasks.md
...
1. **Update High-Traffic Documentation**
   ...
   - `docs/05-project-management/requirements.md` - Update requirements examples
   - `docs/03-development-phases/phase-01-platform-integration/operations/` - Update API reference and usage examples
...
3. **Update Reference Documentation**
   ...
   - Update `docs/06-reference/mock-adapter-integration.md` with current names
   - Add migration notices to historical changelogs

4. **Update Project Planning Docs**
   - `docs/05-project-management/project-charter.md` - Update interface examples
   - `docs/03-development-phases/phase-00-foundation/tasks.md` - Add version notices
