...
**Path note:** Phase 0 lives under `docs/03-development-phases/phase-00-foundation/`. If other material refers to `phase-00-core-foundation`, treat that as the same phase; this folder is canonical in the repository.
...
- [Phase 1 README](../phase-01-platform-integration/README.md) (next phase; confirm path if renamed)
