...
**Path note:** Phase 1 lives under `docs/03-development-phases/phase-01-platform-integration/`. If other material refers to `phase-01-platform-integration` or `phase-1`, treat those as the same phase; this folder is canonical in the repository.
...
- [Phase 0 Execution Plan](../phase-00-foundation/EXECUTION-PLAN.md) (previous phase)
- [Phase 2 README](../phase-02-agent-intelligence/README.md) (next phase; confirm path if created)
