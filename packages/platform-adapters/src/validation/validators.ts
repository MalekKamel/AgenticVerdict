import type { NormalizedMetricRecord, NormalizedPlatformSnapshot } from "../normalization/types";
 ...
 */
export function validateCrossFieldCtr(snapshot: NormalizedPlatformSnapshot): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
