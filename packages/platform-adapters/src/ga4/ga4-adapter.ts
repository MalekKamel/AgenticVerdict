...
export interface Ga4PlatformAdapterOptions extends BasePlatformAdapterOptions {
  fetchImpl?: typeof fetch;
  /** Defaults to {@link createPlatformTokenBucket}("ga4"). */
 ...
 */
export class Ga4PlatformAdapter extends BasePlatformAdapter {
  readonly platform: PlatformType = "ga4";
  ...
  constructor(options: Ga4PlatformAdapterOptions) {
    ...
    this.perRequestBucket =
      requestTokenBucket !== undefined ? requestTokenBucket : createPlatformTokenBucket("ga4");
