...
export function designTokensToCssVariables(tokens: DesignTokens): Record<string, string> {
  return {
    "--global-color-primary": tokens.colors.primary,
    "--global-color-secondary": tokens.colors.secondary,
    "--global-color-accent": tokens.colors.accent,
    "--global-color-success": tokens.colors.success,
    "--global-color-warning": tokens.colors.warning,
    "--global-color-error": tokens.colors.error,
    "--global-color-info": tokens.colors.info,
    "--global-color-bg": tokens.colors.semantic.background,
    "--global-color-fg": tokens.colors.semantic.foreground,
    "--global-color-border": tokens.colors.semantic.border,
    "--global-font-body": tokens.typography.families.body,
    "--global-font-heading": tokens.typography.families.headings,
    "--global-space-xs": tokens.spacing.xs,
    "--global-space-sm": tokens.spacing.sm,
    "--global-space-md": tokens.spacing.md,
    "--global-space-lg": tokens.spacing.lg,
    "--global-radius-md": tokens.borders.radius.md,
  };
}
